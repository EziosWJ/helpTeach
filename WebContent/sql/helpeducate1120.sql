...
CREATE TABLE `hae_community_service_model` (
  ...
  `csReciver` varchar(30) DEFAULT NULL,
  `csCreateDate` date DEFAULT NULL,
...
CREATE TABLE `hae_talk_education_model` (
  ...
  `teReciver` varchar(30) DEFAULT NULL,
  `teCreateDate` date DEFAULT NULL,
