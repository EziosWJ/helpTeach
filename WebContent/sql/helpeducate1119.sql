...
CREATE TABLE `hae_community_service_model` (
  ...
  `csHelper` varchar(30) DEFAULT NULL,
  `csDate` datetime DEFAULT NULL,
  `csReason` varchar(255) DEFAULT NULL,
  `ucId` int(4) DEFAULT NULL,
  `csPlace` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`csId`)
...
-- ----------------------------
INSERT INTO `hae_community_service_model` VALUES ('1', '阿文', '2018-09-02 16:00:00', '额为', '4', '富士康');
INSERT INTO `hae_community_service_model` VALUES ('2', '为', '2018-11-02 16:00:00', '额外全额', '4', '煤炭机械');
...
CREATE TABLE `hae_daily_check_in_model` (
  ...
  `diName` varchar(255) DEFAULT NULL,
  `diLeader` int(255) DEFAULT NULL,
  `diReciver` int(255) DEFAULT NULL,
  `diCreateDate` datetime DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `hae_daily_check_in_model` VALUES ('4', null, null, '3', '2018-11-14 00:00:00', null, '1', null, null);
INSERT INTO `hae_daily_check_in_model` VALUES ('5', null, null, '6', '2018-11-14 00:00:00', null, '3', null, null);
INSERT INTO `hae_daily_check_in_model` VALUES ('6', null, null, '0', '2018-11-14 00:00:00', null, '3', null, null);
INSERT INTO `hae_daily_check_in_model` VALUES ('7', null, null, '0', '2018-11-15 00:00:00', null, '1', null, null);
INSERT INTO `hae_daily_check_in_model` VALUES ('8', null, null, '3', '2018-11-15 00:00:00', null, '2', null, null);
...
CREATE TABLE `hae_eduplan_model` (
  ...
  `epContinuing` varchar(255) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `hae_eduplan_model` VALUES ('12', '应急', '高', '2个月', '认真学习两个月', '2018-11-07', '看好，别让跑了', '0');
...
CREATE TABLE `hae_foul_record_model` (
  `frId` int(11) NOT NULL AUTO_INCREMENT,
  `frHelper` varchar(30) DEFAULT NULL,
  `frDate` datetime DEFAULT NULL,
  `frReason` varchar(255) DEFAULT NULL,
  `ucId` int(4) DEFAULT NULL,
  PRIMARY KEY (`frId`)
...
-- ----------------------------
INSERT INTO `hae_foul_record_model` VALUES ('5', '321', '2018-11-02 15:00:00', '323', '3');
INSERT INTO `hae_foul_record_model` VALUES ('6', '李杰', '2018-10-11 15:44:40', '周一没上课', '5');
...
CREATE TABLE `hae_interview_record_model` (
  ...
  `irHelper` varchar(30) DEFAULT NULL,
  `irDate` datetime DEFAULT NULL,
  `irReason` varchar(255) DEFAULT NULL,
  `ucId` int(5) DEFAULT NULL,
  PRIMARY KEY (`irId`)
...
-- ----------------------------
INSERT INTO `hae_interview_record_model` VALUES ('2', '李杰', '2018-10-31 19:00:00', '家里有点急事，今天请个假。', '6');
INSERT INTO `hae_interview_record_model` VALUES ('3', 'lijie', '2018-10-31 20:00:00', '昨天把肚子吃坏了，没办法上课！', '5');
INSERT INTO `hae_interview_record_model` VALUES ('4', '王丽刚', '2018-11-01 11:00:00', '感冒挺严重的，无法行走', '5');
INSERT INTO `hae_interview_record_model` VALUES ('5', 'wangligang', '2018-11-01 16:00:00', '今天由于生病，无法上课！', '4');
INSERT INTO `hae_interview_record_model` VALUES ('6', 'wj', '2018-11-16 09:00:00', 'hao', '3');
...
CREATE TABLE `hae_labour_education_model` (
  ...
  `leHelper` varchar(30) DEFAULT NULL,
  `leDate` datetime DEFAULT NULL,
  `leReason` varchar(255) DEFAULT NULL,
  `ucId` int(11) DEFAULT NULL,
  `lePlace` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`leId`)
...
-- ----------------------------
INSERT INTO `hae_labour_education_model` VALUES ('1', 'lijie', '2018-10-18 08:00:00', '家里有点急事，今天请个假。', '5', null);
INSERT INTO `hae_labour_education_model` VALUES ('2', '王坚', '2018-10-19 08:00:00', '妈妈/爸爸/爷爷/奶奶生病了，我得去趟医院。', '5', null);
INSERT INTO `hae_labour_education_model` VALUES ('3', '空情关', '2018-10-25 08:00:00', '阳光太强中暑晕倒', '5', '富士康');
INSERT INTO `hae_labour_education_model` VALUES ('4', null, null, null, '4', null);
INSERT INTO `hae_labour_education_model` VALUES ('5', '32', '2018-11-03 10:00:00', '2342', '5', '富士康');
INSERT INTO `hae_labour_education_model` VALUES ('6', null, null, null, '5', null);
INSERT INTO `hae_labour_education_model` VALUES ('7', '213', '2018-11-14 11:00:00', '21', '3', '富士康');
...
CREATE TABLE `hae_leave_record_model` (
  `reId` int(5) NOT NULL AUTO_INCREMENT,
  `reUsername` varchar(30) DEFAULT NULL,
  `reHelper` varchar(255) DEFAULT NULL,
  `reReason` varchar(255) DEFAULT NULL,
  `reDate` datetime DEFAULT NULL,
  `ucId` int(255) DEFAULT NULL,
  PRIMARY KEY (`reId`)
...
-- ----------------------------
INSERT INTO `hae_leave_record_model` VALUES ('17', '孔庆官', '11', '生病', '2018-10-27 17:00:00', '5');
INSERT INTO `hae_leave_record_model` VALUES ('19', '李杰', '342', '感冒', '2018-10-28 15:45:00', '5');
INSERT INTO `hae_leave_record_model` VALUES ('20', '孔庆官', '342', '肚子疼', '2018-10-28 15:45:00', '5');
INSERT INTO `hae_leave_record_model` VALUES ('21', null, 'wangligang', '家里有急事', '2018-11-02 10:15:00', '4');
INSERT INTO `hae_leave_record_model` VALUES ('22', null, '老师', '天气原因', '2018-11-02 11:15:00', '5');
INSERT INTO `hae_leave_record_model` VALUES ('23', null, 'jj', 'ee', '2018-11-03 10:00:00', '3');
INSERT INTO `hae_leave_record_model` VALUES ('24', null, '外出', null, '2018-11-08 11:00:00', '2');
INSERT INTO `hae_leave_record_model` VALUES ('25', null, '123', '5', '2018-11-15 17:00:00', '2');
INSERT INTO `hae_leave_record_model` VALUES ('26', null, 'wj', '病假', '2018-11-16 10:00:00', '2');
INSERT INTO `hae_leave_record_model` VALUES ('27', null, 'wj', '病假', '2018-11-16 10:00:00', '2');
INSERT INTO `hae_leave_record_model` VALUES ('28', null, 'wj', '病假', '2018-11-16 10:00:00', '2');
INSERT INTO `hae_leave_record_model` VALUES ('29', null, 'wj', '病假', '2018-11-16 10:00:00', '2');
...
-- ----------------------------
INSERT INTO `hae_mind_lead_model` VALUES ('1', null, '4', '王坚', '2018-11-03 00:00:00', '比较良好', null);
INSERT INTO `hae_mind_lead_model` VALUES ('2', null, '3', '王坚', '2018-11-05 00:00:00', '状态良好', null);
INSERT INTO `hae_mind_lead_model` VALUES ('3', null, '2', '孔庆官', '2018-11-07 00:00:00', '一般', null);
...
CREATE TABLE `hae_opinion_record_model` (
  ...
  `orHelper` varchar(30) DEFAULT NULL,
  `orDate` datetime DEFAULT NULL,
  `orReason` varchar(255) DEFAULT NULL,
  `ucId` int(5) DEFAULT NULL,
  PRIMARY KEY (`orId`)
...
-- ----------------------------
INSERT INTO `hae_opinion_record_model` VALUES ('5', '345', '2018-11-02 15:00:00', '54', '3');
INSERT INTO `hae_opinion_record_model` VALUES ('6', '李杰', '2018-10-01 16:00:00', '良好', '3');
INSERT INTO `hae_opinion_record_model` VALUES ('7', '2', '2018-11-03 09:00:00', null, '3');
INSERT INTO `hae_opinion_record_model` VALUES ('8', null, '2018-11-06 20:00:00', null, '2');
INSERT INTO `hae_opinion_record_model` VALUES ('9', null, '2018-11-06 20:00:00', null, '2');
INSERT INTO `hae_opinion_record_model` VALUES ('10', null, '2018-11-06 20:00:00', null, '2');
...
CREATE TABLE `hae_talk_education_model` (
  ...
  `teHelper` varchar(30) DEFAULT NULL,
  `teDate` datetime DEFAULT NULL,
  `teReason` varchar(255) DEFAULT NULL,
  `ucId` int(3) DEFAULT NULL,
  PRIMARY KEY (`teId`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
-- ----------------------------
INSERT INTO `hae_talk_education_model` VALUES ('4', '李杰', '2018-10-25 14:42:44', '良好', '5');
...
-- ----------------------------
INSERT INTO `hae_user_record_model` VALUES ('1', '3', 'HQQ', '23', '太原市小店区大唐花园', '5', '8', '1', null);
INSERT INTO `hae_user_record_model` VALUES ('2', '6', 'YCC', null, null, '5', '1', null, null);
INSERT INTO `hae_user_record_model` VALUES ('3', '0', '李杰', '21', '山西省吕梁市', '5', '1', '1', '上课玩手机');
